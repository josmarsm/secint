...
global $db;
$sql = 'SELECT * FROM candidato where pagamento_inscricao="Sim" and documentacao="Não" order by nome';
...
Lista dos candidatos que não encaminharam envelopes para avaliação.<br>
<p>
