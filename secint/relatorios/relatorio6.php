...
global $db;
$sql = 'SELECT * FROM candidato where pagamento_inscricao="Não" and documentacao="Sim" order by nome';
...
Lista dos candidatos que efetuaram o pagamento da taxa de inscrição.<br>
<p>
