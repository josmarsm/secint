...
<div id="candidatoModal_comissao" class="modal fade">
    <div class="modal-dialog modal-lg">
        <form method="post" id="candidato_form_comissao" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="chat-panel panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <p>
                                        Lorem ipsum dolor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consecteturor sit amet, consectetur  adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                                    </p>                                    
                                </div>
                                <!-- /.panel-body -->
                                <div class="panel-footer">
                                    <div class="input-group">
                                        <input id="gravaObservacao" type="text" class="form-control input-sm" placeholder="Escreva uma nova observação..." />
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning btn-sm" id="btn-chat" onclick="readObservacao()">
                                                Grava
                                            </button>
                                        </span>
                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" onclick='salvaAvalicacaoComissao();' name="salva_avaliacao" id="salva_avaliacao " class="btn btn-success" value="Salvar Avaliação" />
                        <a id="salvaAvalicacaoComissao" data-role="button"  onclick="salvaAvalicacaoComissao();">Click on Button</a>
