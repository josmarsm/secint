...
<td width="33%">UFSM</td>
<td width="33%" align="center"></td>
<td width="33%" style="text-align: right;"><span style="font-weight: bold;">página {PAGENO} de {PAGENO}</span></td>
</tr></table>
';
...
$html = '
<h2 style="margin-collapse: none; margin-top: 5mm; text-align:center;">Selecionados para Etapa 2</h2>
<p>Lista dos candidatos selecionados para a Etapa 2 do processo seletivo para ingresso no PGCC 2018\1. </p>
<h3>Nº Inscrição / Nome</h3>
<p>'.$lista.'</p>
';
